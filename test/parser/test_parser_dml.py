...
from sqlml_parser.parser.tree.with_stmt import WithHasQuery
...
from sqlml_parser.parser.tree.expression import ComparisonExpression
...
class MyTestCase(unittest.TestCase):
    ...
    def test_lock_in_share_mode(self):
        ...
        """
        result = mysql_parser.parse(sql, debug=True)
        assert isinstance(result, Statement)
